...
- Split Explorer into public read-only `/explorer` and IAP-protected
  ...
  on Cloud Run revision `explorer-admin-00002-sjn`.
...
| CHM-SEC-003 | High | Completed; deployed | CHM depends on `IAP_JWT_AUDIENCE` for app-level IAP JWT validation. Terraform sets it, and the app now fails creation in production if the value is missing. Deployed on 2026-08-31 as image `us-east4-docker.pkg.dev/chm-network/chm-apps/chm@sha256:5456cece6520be75630a47a0aa913d9485593ef9a8da6ff040efe29a313e04c1`; Cloud Run revision `chm-00010-65w` is ready and serving 100% traffic. | Keep `NODE_ENV=production` and `IAP_JWT_AUDIENCE` in Terraform. Keep the fail-closed test in the CHM test suite. |
...
- Latest CHM deploy on 2026-08-31 from commit `9cf7718`: Cloud Run revision
  `chm-00010-65w`, image
  `us-east4-docker.pkg.dev/chm-network/chm-apps/chm@sha256:5456cece6520be75630a47a0aa913d9485593ef9a8da6ff040efe29a313e04c1`
- Latest Explorer deploy on 2026-08-31 from Ryu commit `c1fea0b`: public
  revision `explorer-00012-xxd`, admin revision `explorer-admin-00002-sjn`,
  private API revision `explorer-api-00011-9j2`, public image
  `us-east4-docker.pkg.dev/chm-network/chm-apps/explorer-public@sha256:a3bb4e4a8cdb71f0bc1c4f22603513b636f1c8e3c470eb5809370172384695c5`,
  and admin image
