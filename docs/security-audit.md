...
- Split Explorer into public read-only `/explorer` and IAP-protected
  ...
  on Cloud Run revision `explorer-admin-00003-n7c`.
...
- Latest Explorer deploy on 2026-08-31 from Ryu commit `4fac03e`: public
  revision `explorer-00013-6c6`, admin revision `explorer-admin-00003-n7c`,
  private API revision `explorer-api-00012-v62`, public image
